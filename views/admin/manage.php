					...
					<tbody>
						...
						<tr>
							<td style="text-align:right">
								<?php echo anchor('admin/pyrocourse/edit_course/'.$this->uri->segment(4), lang('pyrocourse:edit_course'), 'class="button"');?>
								<?php echo anchor('admin/pyrocourse/delete_course/'.$this->uri->segment(4), lang('pyrocourse:delete_course'), 'class="button delete confirm"');?>
							</td>
						</tr>
					</tbody>
				</table>
	...
	<div class="one_half last">
		...
		<section class="title">
			<h4>
				...
				<?php echo anchor('admin/pyrocourse/create_lesson/'.$this->uri->segment(4), lang('pyrocourse:new_lesson'), 'class="button" style="float:right;margin-right:17px;"');?>
			</h4>
		</section>
				...
				<div id="page-list">
					<ul class="sortable">
						...
						<li id="lesson_<?php echo $value['id']; ?>">
							<div>
								<a href="<?php echo site_url('admin/pyrocourse/manage_lesson/'.$value['id']); ?>" 
